...
The standard deviation of the residuals (of$\epsilon_i$) is smaller in model m1 (1.446) than in model m0 (2.268). The `model` part of the data has increased and the `error` part has decreased, goingfrom model m0 to m1. 
