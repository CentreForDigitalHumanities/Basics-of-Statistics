...
> Homework Q6 (p.20): Download the file `FruitData.csv` from the repository for this course: \\
  <https://github.com/CentreForDigitalHumanities/Basics-of-Statistics/blob/main/FruitData.csv> (right-click, Save as...) \\
...
students <- read.csv('https://www.hugoquene.nl/R/students.csv')
