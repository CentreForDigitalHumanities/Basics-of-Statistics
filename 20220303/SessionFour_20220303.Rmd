...
if we add predictor `height` to the model, the value of the intercept changes. It is now the expected value of `shoesize` if `height` is zero. For a person with height zero, the expected shoesize is 2.8.
